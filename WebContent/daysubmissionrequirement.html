...
<div id="main_container">
    ...
    <center><h2> Submission's </h2> </center>
		 ...
		 <fieldset>
					 <dl>
                        ...
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter date" />hidden</dd>
                    </dl>
                    <dl>
                        <dt><label for="email">Date:</label></dt>
                        <dd><input type="date" name="" id="" size="40" placeholder="Enter date" /></dd>
                    </dl>
					...
					<dl>
                        <dt><label for="email">Consultant:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Consultant" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Final Rate:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Final Rate" ></dd>
                    </dl>
					...
					<dl>
                        ...
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Vendor Name" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Phone Number:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Phone Number" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Vendor Email:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Vendor Email" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Implementation Partner / PV:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter PV" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Recruiter Name:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter RN" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="gender">VISA Type:</label></dt>
                        <dd>
                            <select size="1" name="gender" id="" size="40">
                                <option value="">Select VISA Type</option>
                                <option value="">CPT</option>
                                <option value="">OPT</option>
                                <option value="">H1B</option>
                                <option value="">H4EAD</option>
								<option value="">GCEAD</option>
								<option value="">GC</option>
								<option value="">USC</option>
