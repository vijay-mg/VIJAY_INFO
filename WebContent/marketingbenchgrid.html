...
<div id="main_container">
    ...
    <center><h2> Zenith Hot List </h2> </center>
		
	<dl>
        <dt><label for="color">Select option</label></dt>
            <dd>
                            <input type="radio" name="type" id="" value="" /><label class="check_label">Company</label>
							<input type="radio" name="type" id="" value="" /><label class="check_label">Name</label>
							<input type="radio" name="type" id="" value="" /><label class="check_label">Technology</label>
							<input type="radio" name="type" id="" value="" /><label class="check_label">Location</label>
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Technology</th>
            <th scope="col" class="rounded">Experience</th>
			<th scope="col" class="rounded">Location</th>
            <th scope="col" class="rounded">ReLocation</th>
            <th scope="col" class="rounded">Rate</th>
    ...
    <tr>
		...
		<td>Open</td>
		<td>$70/hr</td>
        <td><a href="benchinfo.html"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
...
<div class="pagination">
	...
	<center><h2> Finacle Hot List </h2> </center>
	...
	<br> <br/>
	<h1> </h1>
		<center><h2> H1T Hot List </h2> </center>
