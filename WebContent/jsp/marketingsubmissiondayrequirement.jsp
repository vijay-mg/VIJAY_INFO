...
<body>
  ...
  <div id="main_container">
    ...
    <center><h2>Submission of Day Report</h2> </center>
      <div class="form">
	  <fieldset>
         <form action="" method="post" class="niceform">
					 <dl>
                        <dt><label for="">Select Recruiter:</label></dt>
                        <dd>
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Consultant</th>
            <th scope="col" class="rounded">Final Rate</th>
			<th scope="col" class="rounded">Location</th>
            <th scope="col" class="rounded">Vendor Email</th>
            <th scope="col" class="rounded">Phone Number</th>
			<th scope="col" class="rounded">Client</th>
			<th scope="col" class="rounded">Recruiter</th>
        </tr>
    </thead>
        <tfoot>
    	<tr>
    ...
    <tr>
		...
		<td>45$/Hr</td>
		<td> Columbus</td>
		<td>Sudheer@gmail.com</td>
		<td>2014971010 ext 105</td>
		<td>Pullskill Tech</td>
		<td>Srinvas</td>
	</tr>
	 <tr>
