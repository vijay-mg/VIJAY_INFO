  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
       <!-- <a href="a.jpg" target="_blank">-->
          <img src="images/a.jpg" alt="Pulpit Rock" style="width:50%">
          <div class="caption">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
          ...
          <img src="images/b.png" alt="Moustiers Sainte Marie" style="width:50%">
          <div class="caption">
            <p>Java Technologies.</p>
          </div>
    ...
    <div class="col-md-4">
      <div class="thumbnail">
          ...
          <img src="images/c.jpg" alt="Cinque Terre" style="width:50%">
          <div class="caption">
    ...
    <div class="footer">
    	...
    	<div class="left_footer">Copyright © U&I Informatics. <a href="#">ZENITH-HR</a></div>
