         ...
         <form action="" method="post" class="niceform">
		  ...
		  <fieldset>
				<h4> Personal Information </h4>
					...
					<dl>
                        <dt><label for="email">Nativity:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Nativity"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="gender">Current Status:</label></dt>
                        <dd>
                            <select  name="currentstatus" onchange='checkvalue(this.value)' >
                                ...
                                <option value="others1">any other specify</option>
                            </select>
                        </dd>
                    </dl>
					<dl>
