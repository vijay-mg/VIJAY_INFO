   ...
   <div class="left_content">
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Company</th>
            <th scope="col" class="rounded">CandidateName</th>
            <th scope="col" class="rounded">Technology</th>
			<th scope="col" class="rounded">Location</th>
            <th scope="col" class="rounded">Positions</th>
    ...
    <tr>
		...
		<td>CMA</td>
            ...
            <td><a href="closer.html"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
