...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> Technical Screening </h2> </center>
...
<dl>
					<table border="0">
						<tr>
							...
							<th><label for="gender">Manager Rating</label></th>
							<th><label for="gender">Manager Remarks</label></th>
						</tr>
						<br>
						<tr>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Skill Set"/></td>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Experience"/></td>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Self Rating"/></td>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Manager Rating"/></td>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Manager Remarks"/></td>
						</tr>
						<tr>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Skill Set"/></td>
							<td><input type="text" name="" id="" size="11" placeholder="Enter Experience"/></td>
					...
					<dl>
                        <dt><label for="gender">Communication:</label></dt>
                        <dd>
