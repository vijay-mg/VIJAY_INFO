...
<div id="main_container">
    ...
    <center><h2> Register-Complaint</h2> </center>
         ...
         <form action="" method="post" class="niceform">
                    ...
                    <fieldset>
					<dl>
						<dt><label for="">Register No :</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder=""/>hidden
					      </dd>
                    </dl>
						<dl>
                        <dt><label for="">Name of the Candidate :</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Candidate Name"/>
					      </dd>
                    </dl>
						<dl>
                        <dt><label for=""> Candidate Email:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Email"/>
					      </dd>
                    </dl>
					<dl>
                        <dt><label for="comments">Complaint:</label></dt>
                        <dd><textarea name="comments" id="comments" rows="5" cols="36"  placeholder="Enter Complaint"></textarea></dd>
                    </dl>
					<dl>
                        <dt><label for="email">Due Date:</label></dt>
