...
<div id="main_container">
   ...
   <center><h2>Interview Update</h2> </center>
        <div class="form">
			<form action="" method="post" class="niceform">
					 <dl>
                        <dt><label for="">Select Candidate:</label></dt>
                        <dd>
                       		<select size="1" name="" id="">
                                <option value="">Select One</option>
                                <option value="">veena@gmail.com</option>
                                <option value="">Siddu@gmail.com</option>
                                <option value="">tiksha@gmail.com</option>
                            </select>
					      </dd>
                    </dl>
			<dl class="submit"><br>
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Vendor Name</th>
