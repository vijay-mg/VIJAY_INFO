...
<body>
  ...
  <div id="main_container">
   ...
   <center> <h2>User Roles</h2> </center>
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        <dt><label for="gender">Select mails:</label></dt>
                        <dd>
                            <select size="1" name="gender" id="">
							    <option value="">select One</option>
                                <option value="">vinod@gmail.com</option>
                                <option value="">Sukhendra@gmail.com</option>
                                <option value="">thrinadh@gmail.com</option>
                                <option value="">veerraju@gmail.com</option>
                                <option value="">Neelima@gmail.com</option>
                            </select>
                        </dd>
                    </dl>
                    <dl>
                        <dt><label for="gender">User roles:</label></dt>
                        <dd>
                            <select size="1" name="gender" id="">
								<option value="">select one</option>
				...
				<hr>
				<br>
		<table id="rounded-corner" summary="2016 Major IT Companies' Profit" align="center">
				<thead>
					<tr>
						<th scope="col" class="rounded-company"></th>
						<th scope="col" class="rounded">User Name</th>
						<th scope="col" class="rounded">User Email Id</th>
						<th scope="col" class="rounded">Assign Role</th>
