...
<div id="main_container">
    ...
    <center><h2> Closer( All / Employee ) </h2> </center>
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
					<dl>
                        <dt><label for="gender">Candidate Name:</label></dt>
                        <dd>
                            <select size="1" name="gender" id="">
                                <option value="">Select Candidate </option>
                                <option value="">veena</option>
                                <option value="">siddharth</option>
					...
					<dl>
                        <dt><label for="email">Technology:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Technology" /></dd>
                    </dl>
                    
					<dl>
                        <dt><label for="email">Experience:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Experience"/></dd>
                    </dl>
					...
					<dl>
                        <dt><label for="email">Position:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Position" /></dd>
                    </dl>
					
					
					<dl>
                        <dt><label for="email">Rate:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Rate" /></dd>
                    </dl>
					<br><br><br>
					<dl>
                        <dt><label for="gender">Recruiter:</label></dt>
                        <dd>
                            <select  size="1" name="gender" id="" style="width:270px">
                                <option value="">Select option </option>
                                <option value="">srinivas@gmail.com</option>
                                <option value="">uday@gmail.com</option>
                                <option value="">venkatesh@gmail.com</option>
                            </select>
                        </dd>
                    </dl>
					...
					<dl>
                        <dt><label for="email">Project Start Date:</label></dt>
                        <dd><input type="date" name="" id="" size="40" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Project End Date:</label></dt>
                        <dd><input type="date" name="" id="" size="40" style="width:250" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Vendor Details:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Vendor Details" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Implementation/Prime Vendor:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Implementation/Prime" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Client:</label></dt>
                        <dd><input type="text" name="" id="" size="40" placeholder="Enter Client" /></dd>
                    </dl>
					<br><br><br>
					<dl>
                        <dt><label for="gender" style="color:green">Employee Approval:</label></dt>
                        <dd>
                            <select size="1" name="gender" id="">
                                <option value="">Select option </option>
					...
					<dl>
                        <dt><label for="comments"> Remarks :</label></dt>
                        <dd><textarea name="comments" id="comments" rows="5" cols="36"  placeholder="Enter Remarks "></textarea></dd>
                    </dl>
					
					<br>
					
					<dl>
                        <dt><label for="" style="color:red">Admin Approval :</label></dt>
                        <dd><br>
