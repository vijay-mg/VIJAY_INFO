...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> H1B-Filing </h2> </center>
			...
			<fieldset>
					 ...
					 <dl>
                        ...
                        <dd>
                       		<select size="1" name="" id="">
                                ...
                                <option value="">Zenith Services Inc</option>
                                <option value="">Finacle Soft Inc </option>
                            </select>
					      </dd>
                    </dl>
					...
					<dl>
                        ...
                        <dd>
                       		<select size="1" name="" id="">
                                <option value="">Select One</option>
                                <option value="">Status Filed</option>
                                <option value="">Status Held</option>
					...
					<dl>
                        <dt><label for="email">Remarks:</label></dt>
    ...
    <div class="footer">
    	...
    	<div class="right_footer"><a href="http://www.uiinfotech.com/"><img src="images/ZENITH.png" alt="" title="" border= /></a></div>    
    </div>
