...
<div id="main_container">
    ...
    <center> <h2> Submission of Day Requirement </h2> </center>
	<div class="form">
		<form action="" method="post" class="niceform">
	<center>From Date: <input id="dob" name="dob" type="date">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date: <input id="dob" name="dob" type="date"> &nbsp &nbsp

                    <input type="submit" name="submit" id="submit" value="Submit" class="submit" /> </center>
		</form>
	</div>
	</dl>
	<br>
    ...
    <thead>
    	<tr>
			...
			<th scope="col" class="rounded">Birthday Date</th>
...
<br>
 <h2> Birthdays of All Internal Employees </h2> 
	<div class="form">
		<form action="" method="post" class="niceform">
	<center>From Date: <input id="dob" name="dob" type="date">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date: <input id="dob" name="dob" type="date"> &nbsp &nbsp
