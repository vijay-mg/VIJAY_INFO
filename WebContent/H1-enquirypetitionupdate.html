...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> Petition Update </h2> </center>
	...
	<div class="form">
         <form action="" method="post" class="niceform">
					...
					<br>
					<dl>
                        <dt><label for="">Approval Status:</label></dt>
                        <dd>
                       		<select size="1" name="" id="">
                                <option value="">Select one</option>
                                <option value="">Approved</option>
                                <option value="">RFE</option>
                                <option value="">Rejected</option>
								<option value="">RFE Replied</option>
                            </select>
					      </dd>
                    </dl>
					
					<br>
					<h2 align="center"> If RFE </h2>
					
					<dl>
                        <dt><label for="email">Reply Due Date:</label></dt>
                        <dd><input type="Date" name="" id="" size="54" /></dd>
                    </dl>
					
					<dl>
                        <dt><label for="upload">RFE Document Attachement:</label></dt>
