      ...
      <div class="form">
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
					...
					<dl>
                        <dt><label for="comments"> Submit Post:</label></dt>
                        <dd><textarea name="comments" id="comments" rows="5" cols="36"  placeholder="Message">
						</textarea><input type="submit" name="submit" id="submit" value="Post" /></dd>
                    </dl>
                    <dl>
					...
					<dl>
                        <dt><label for="email">Neelima:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
					...
					<br/>
					<dl>
                        <dt><label for="email">Kolla:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
					...
					<br/>
					<dl>
                        <dt><label for="email">Srinivas:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
					...
					<br/>
					<dl>
                        <dt><label for="email">Venkatesh:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
					...
					<br/>
					<dl>
                        <dt><label for="email">Uday:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
					...
					<br/>
					<dl>
                        <dt><label for="email">Shyam:</label></dt>
                        <dd> Technical Screening is the process of testing and evaluating a candidate's skills and experiences against a set of requirements using conversation-friendly questions to uncover strengths and weaknesses without appearing confrontational. There are three types of screening questions. </dd>
                    </dl>
                    <dl>
