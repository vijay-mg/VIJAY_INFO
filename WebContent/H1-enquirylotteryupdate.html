...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> Lottery Update </h2> </center>
	...
	<div class="form">
         <form action="" method="post" class="niceform">
			<fieldset>
					...
					<h2 align="center"> If Approved </h2>
					
					<dl>
                        <dt><label for="email">ECA Number:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter ECA Number "/></dd>
                    </dl>
					
					<h2  align="center"> Automatically Congratulations Email </h2>
