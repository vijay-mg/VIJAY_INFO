...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> SD Confirmation </h2> </center>
         ...
         <form action="" method="post" class="niceform">
			<fieldset>
					...
					<dl>
                        ...
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter SD Amount"/>Automatically</dd>
                    </dl>
						
					
					<dl>
                        <dt><label for="email">Due:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Due"/></dd>
                    </dl>
					<dl>
                        <dt><label for="password">Receipt Date :</label></dt>
                        <dd><input type="Date" name="" id="" size="40" /></dd>
                    </dl>

					<dl>
                        <dt><label for="email">Amount:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Amount"/></dd>
                    </dl>
