...
<div id="main_container">
   ...
   <div class="right_content">            
    ...
    <center><h2> Financial Screening </h2> </center>
	...
	<div class="form">
         <form action="" method="post" class="niceform">
					...
					<br>
					<dl>
                        <dt><label for="">Select Remuneration:</label></dt>
                        <dd>
                       		<select size="1" name="" id="">
					...
					<dl>
                        <dt><label for="email">Salary Per Month:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Per Month"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Health Insurance:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Health Insurance "/>% of Share</dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Pay Roll Tax:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Pay Roll Tax"/></dd>
                    </dl>
					
					
					<dl>
                        <dt><label for="email">LCA Salary:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter LCA Salary"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Extra Pay Roll Tax:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Extra Pay Roll Tax"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Greencard Expenses:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Greencard Expenses"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">WCL:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter WCL"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">SD Amount:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter SD Amount"/></dd>
                    </dl>
					
					<dl>
                        <dt><label for="email">Other's if any:</label></dt>
                        <dd><textarea name="comments" id="comments" rows="5" cols="36" placeholder="Please enter"></textarea></dd>
                    </dl>
					
					
					<h2 align="center"> Sharing </h2>
					
					<dl>
                        <dt><label for="email">Sharing %:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Sharing %"/></dd>
                    </dl>
					<dl>
                        <dt><label for="email">Health Insurance:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter Health Insurance "/>% of Share</dd>
					...
					<dl>
                        <dt><label for="email">LCA Salary:</label></dt>
                        <dd><input type="text" name="" id="" size="40"  placeholder="Enter LCA"/></dd>
                    </dl>
